...
- **Kontekst:** Model domyślnie nie posiada informacji na temat naszego kontekstu, co utrudnia bądź uniemożliwia stworzenie skutecznych zapytań. Przykładowo, gdy zapytam o "moje projekty", agent nie będzie magicznie wiedział, że AI\_devs i to nawet jeśli w treści dokumentów znajdzie się fraza "Adam współtworzy AI\_devs". Tutaj dopiero wyszukiwanie semantyczne miałoby szansę powiązać te informacje. Znacznie lepszą alternatywą byłby tutaj Graph RAG, czyli system wykorzystujący bazy grafowe.
